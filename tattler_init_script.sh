...
APPLICATION_PATH="/var/www/tattler/server.js"
PIDFILE="/var/run/tattler.pid"
LOGFILE="/var/www/tattler/logs/production.log"
MIN_UPTIME="5000"
SPIN_SLEEP_TIME="2000"
...
export NODE_CONFIG_DIR="/var/www/tattler/config"
