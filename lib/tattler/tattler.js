...
app.get('/rooms/clients', app.callbacks.getRoomsClients);
app.get('/clients', app.callbacks.getClients);
app.get('/clients/sessions', app.callbacks.getClientsSessions);
app.get('/sessions', app.callbacks.getSessions);
app.post('/emit', app.callbacks.postEmit);
app.get('/emit', app.callbacks.getEmit);


app.post('/rooms', app.callbacks.postRooms);
app.post('/clients', app.callbacks.postClients);