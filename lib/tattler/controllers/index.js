...
exports.postEmit = function (req, res) {
    // curl -v --header "Content-Type: application/json" -X POST -d '{"root":"RvQTnn6hFikrspy7HEUS", "room":"broadcast", "bag": {"handler":"console.log", "namespace":"global", "message":"Ahoy"} }' http://tattler.app/tattler/emit
...
exports.getEmit = function (req, res) {
    // $.ajax({url:'http://tattler.app/tattler/emit', type: "GET", data: {"root":"RvQTnn6hFikrspy7HEUS", "room":"broadcast", "bag": {"handler":"console.log", "namespace":"global", "message":"Ahoy"} }, dataType: 'jsonp' });
