...
function view(res, template, data)
{
    var context = {};
    context.layout = null;
    context.data = data;
...
exports.getRoot = function (req, res) {
    return view(res, __dirname + '/../views/index', {});
};

exports.postEmit = function (req, res) {
    // curl -v --header "Content-Type: application/json" -X POST -d '{"root":"RvQTnn6hFikrspy7HEUS", "room":"datatables_languages", "bag": {"handler":"growl", "title":"MyTitle", "text":"Ahoy"} }' http://tattler.app/tattler/emit
...
exports.getEmit = function (req, res) {
    // $.ajax({url:'http://tattler.app/tattler/emit', type: "POST", data: {"root":"RvQTnn6hFikrspy7HEUS", "bag": {"handler":"growl", "title":"MyTitle", "text":"Yarrr"} }, dataType: 'jsonp' });
...
exports.postRooms = function (req, res) {
    ...
    // console.log('postRooms', req.body);
    var query = req.body;
